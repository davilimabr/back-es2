...
/// <summary>
/// Valida os dados de uma medicao antes do dominio, com mensagens amigaveis. Os
/// intervalos espelham as invariantes da entidade <c>Medicao</c>.
/// </summary>
public sealed class RegistrarMedicaoValidador : AbstractValidator<RegistrarMedicaoRequisicao>
{
    public RegistrarMedicaoValidador()
    {
